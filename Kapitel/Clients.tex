...
\subsection{Implementierung}
	...
	\subsubsection{Model}
		...
		ergibt sich auch die Änderung, dass die Klassen im Gegensatz zum Model im4
	...
	\subsubsection{HTTP-Client}\label{sssec:http_client}
		...
		durch den bei der Erzeugung des HTTP-Clients angegebenen Typs, zum Beispiel
		Teacher. Zudem ist zu beachten dass ausser dem Query-String keine weiteren
		Informationen an das Backend geschickt wird, da diese Methode nur Daten aus
		...
		Konfiguration wie zum Beispiel erweiterte Mappings und Ähnliches
		festzulegen.\\
		...
		Http-Clients wird dies bei Erzeugung festgelegt. "`content"' stellt einen
		...
		Referenzschleifen (ERKLÄRUNG EINFÜGEN) oder wie Referenzen allgemein behandelt
