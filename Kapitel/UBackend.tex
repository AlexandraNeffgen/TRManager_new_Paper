...
\subsection{Implementierung}
	...
	wie Dependency Injection und ähnliches, das die Implementierung eines
	...
	\subsubsection{Model}
		...
		fest, wie zum Beispiel die ID.(Siehe Anhang, Seite \pageref{LazyObject})	 
		\item[Teacher]
	...
	\paragraph{Datenbank}
		...
		\pageref{Hibernate}) aus dem Objektmodell(Beschrieben in Kapitel \ref{Model}
		auf Seite \pageref{Model}) generiert.
	...
	Beispiel POST, PUT oder DELETE) bearbeiten. 
