...
implementierten Logik zurückgeben.
	...
	Die Tests werden mit MockMVC aus
		\paragraph{Teacher-Controller}
			...
			MockMVC-Objekt ein RequestBuilder, der für die Erzeugung des Web-Requests
			verwendet wird. 
			
			Das Testen der
			nicht-idempotenten Methoden wie addTeacher muss darauf geachtet werden, dass der Controller die Ausnahmefälle behandelt, und die Datensätze richtig ändert beziehungsweise neu anlegt.\\
