...
\subsection{Implementierung}
	...
	\subsubsection{Model}\label{sssec:model}
		Das Model legt die Datenstrukturen fest, in der das Backend arbeitet und
		antwortet.
	...
	In Listing \ref{repository_definition} ist die Definition des Repositories für die
	...
	Spring) (@RestController) bereitgestellt und erlauben eine einfach Zuordnung zu einer
...
implementierten Logik zurückgeben.
	\subsubsection{Controller-Unit-Tests}
	...
	"`erzwungen"'. Im Fall dieser Anwendung werden demnach pro Controller zwei
	Testfälle benötigt, entweder "`Not found"' beziehungsweise "`Internal Server
	Error"' oder "`OK"'.
